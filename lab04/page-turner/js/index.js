const ch1_text = `<h2>Chapter 1</h2>
...
const ch2_text = `<h2>Chapter 2</h2>
...
const ch3_text = `<h2>Chapter 3</h2>
...
const chapter1 = () => {
   // TA said not toggling so can leave blank.
};

const chapter2 = () => {
   document.querySelector('.content').innerHTML = ch1_text + ch2_text;
};

const chapter3 = () => {
   document.querySelector('.content').innerHTML = ch1_text + ch2_text + ch3_text;
};
